 ...
 * [Mode Information]
 *
 * Reference File : GC5035 MIPI data rate 884M official setfile V1.0.3.xlsx
 * Update Data    : 2019-06-25
 * Author         : sgtop9.choi
 *
 *  - Global setting
 *
 *  - Mode setting
 *  [ 0 ] 2576 x 1932(4:3)    @30,  MIPI lane: 2, MIPI data rate(Mbps/lane):  884, Mclk(Mhz): 26
 *  [ 1 ] 2560 x 1440(16:9)   @30,  MIPI lane: 2, MIPI data rate(Mbps/lane):  884, Mclk(Mhz): 26
 *  [ 2 ] 2224 x 1080(18.5:9) @30,  MIPI lane: 2, MIPI data rate(Mbps/lane):  884, Mclk(Mhz): 26
 *  [ 3 ] 2576 x 1188(19.5:9) @30,  MIPI lane: 2, MIPI data rate(Mbps/lane):  884, Mclk(Mhz): 26
 *  [ 4 ] 2576 x 1160(20:9)   @30,  MIPI lane: 2, MIPI data rate(Mbps/lane):  884, Mclk(Mhz): 26
 *  [ 5 ] 1920 x 1920(1:1)    @30,  MIPI lane: 2, MIPI data rate(Mbps/lane):  884, Mclk(Mhz): 26
 *  [ 6 ] 800 x 600(4:3)      @60,  MIPI lane: 2, MIPI data rate(Mbps/lane):  884, Mclk(Mhz): 26
 *
 */
...
const u32 sensor_gc5035_setfile_A_2576x1188_24fps[] = {
	0xfc, 0x01, 0x01,
	0xf4, 0x40, 0x01,
	0xf5, 0xe9, 0x01,
	0xf6, 0x14, 0x01,
...
const u32 sensor_gc5035_setfile_A_2576x1160_24fps[] = {
	0xfc, 0x01, 0x01,
	0xf4, 0x40, 0x01,
	0xf5, 0xe9, 0x01,
	0xf6, 0x14, 0x01,
...
const struct sensor_pll_info_compact sensor_gc5035_pllinfo_A_2576x1188_24fps = {
	EXT_CLK_Mhz * 1000 * 1000,    /* ext_clk */
	884 * 1000 * 1000,            /* mipi_datarate = OPSYCK */
	176800000,                    /* pclk = VTPXCK*/
	2508,                         /* frame_length_lines */
	2936,                         /* line_length_pck */
};

const struct sensor_pll_info_compact sensor_gc5035_pllinfo_A_2576x1160_24fps = {
	EXT_CLK_Mhz * 1000 * 1000,    /* ext_clk */
	884 * 1000 * 1000,            /* mipi_datarate = OPSYCK */
	176800000,                    /* pclk = VTPXCK*/
	2492,                         /* frame_length_lines */
...
const struct sensor_pll_info_compact sensor_gc5035_pllinfo_A_800x600_60fps = {
	EXT_CLK_Mhz * 1000 * 1000,    /* ext_clk */
	442 * 1000 * 1000,            /* mipi_datarate = OPSYCK */
	176800000,                    /* pclk = VTPXCK*/
