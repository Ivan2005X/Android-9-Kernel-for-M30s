...
static void debug_work_func(struct work_struct *work)
{
	...
	unsigned int type;
	ssp_infof("Sensor state: 0x%llx, En: 0x%llx, Ver: %u, Reset cnt: %u, Comm fail: %u, Time out: %u No event : %u",
	          data->sensor_probe_state, data->sensor_en_state, data->curr_fw_rev, data->cnt_reset, data->cnt_com_fail,
